...
IOException, ParserConfigurationException
 {
   ...
   //liste des enseignant,
	NodeList enseignants = ((org.w3c.dom.Document)doc).getElementsByTagName("Enseignant");
	...
	{int sum =0;
		...
		NodeList enseignements = ((org.w3c.dom.Document)doc).getElementsByTagName("Enseignements");
		...
		for (int j =0 ; j < enseignements.getLength(); j++) 
		{
			...
			E_2 = (Element) Nb_heures.item(j);
			// int x = Integer.parseInt(E_2.getTextContent());
			 // sum=sum + Integer.parseInt(E_2.getTextContent());
			 System.out.println("Numbre d'heures : "+E_2);
